...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator_scalex = ObjectAnimator.ofFloat(target,"scaleX",1f,2f);
        animator_scalex.setRepeatCount(ObjectAnimator.INFINITE);
        animator_scalex.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator animator_scaley = ObjectAnimator.ofFloat(target,"scaleY",1f,2f);
        ...
        ObjectAnimator animator_alpha = ObjectAnimator.ofFloat(target,"alpha",1f,0.5f);
